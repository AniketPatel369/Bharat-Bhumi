        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.35fr]">
          ...
          <div className="landing-panel rounded-[28px] p-3 md:p-4 shadow-xl">
            <div className="relative overflow-hidden rounded-[22px] bg-gradient-to-br from-[#fff8ea] via-[#fdfefe] to-[#e6f8f0] p-4 md:p-8 min-h-[420px]">
              <div className="absolute -top-2 left-4 text-7xl opacity-90">💸</div>
              <div className="absolute top-8 right-6 text-5xl opacity-90">🎲</div>
              <div className="absolute bottom-5 right-8 text-7xl opacity-90">🛺</div>
              <div className="absolute bottom-6 left-8 text-6xl opacity-90">💳</div>
              <div className="absolute inset-6 rounded-[18px] border-[10px] border-[#ead8bf] shadow-inner"></div>
